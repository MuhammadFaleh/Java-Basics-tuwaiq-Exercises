...
public class Main {
    ...
    public static void stringReverser(){
        ...
        System.out.printf(" Length of the string: %d And Reversed string: %s" , textInput.length(), strBuilder.reverse());
    }
    ...
    public static void wordChecker(){
        ...
        if (textInput.toLowerCase().contains(keyWord.toLowerCase())){
            System.out.printf(" Keyword \"%s\" is present in the sentence.", keyWord);
        }else System.out.printf(" Keyword \"%s\" is not present in the sentence.", keyWord);
